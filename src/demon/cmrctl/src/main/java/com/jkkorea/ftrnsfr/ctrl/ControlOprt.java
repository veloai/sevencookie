...
import com.jkkorea.ftrnsfr.ctrl.CtrlInfoVO;
import demon.cmrctl.src.main.java.com.jkkorea.ftrnsfr.exception.DataValidationException;
import demon.cmrctl.src.main.java.com.jkkorea.ftrnsfr.json.DvcListMngr;
...
public class ControlOprt {
    ...
    public static void processCtrl(String fileName, Props props) {
        ...
        List<com.jkkorea.ftrnsfr.ctrl.CtrlInfoVO> listVO = parseFile(fileName);
        ...
        for (com.jkkorea.ftrnsfr.ctrl.CtrlInfoVO vo : listVO) {
...
//        }
    ...
    private static List<com.jkkorea.ftrnsfr.ctrl.CtrlInfoVO> parseFile(String file) {
     ...
     * @return
     */
    private static com.jkkorea.ftrnsfr.ctrl.CtrlInfoVO parse(String line) throws DataValidationException {
        com.jkkorea.ftrnsfr.ctrl.CtrlInfoVO vo = new CtrlInfoVO();
