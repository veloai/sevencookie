...
import com.jkkorea.ftrnsfr.ctrl.DvcOp;
import com.jkkorea.ftrnsfr.ctrl.FileChecker;
    ...
    public static String sendOp(CtrlInfoVO vo) {
        ...
        try{
            ...
            try(OutputStream sender = client.getOutputStream(); InputStream receiver = client.getInputStream();) {
                ...
                sData[3] = 0x20;
                sData[4] = 0x01;
                sData[5] = vo.getCmd().equalsIgnoreCase("S") ? com.jkkorea.ftrnsfr.ctrl.DvcOp.SOFT_RESET : DvcOp.HARD_RESET;
                sData[6] = 'E';
                sData[7] = 'O';
                sData[8] = 'D';
